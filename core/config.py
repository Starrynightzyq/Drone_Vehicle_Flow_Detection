...
# Set the class name
__C.YOLO.CLASSES                = "./VisDrone2018-tf-yolo/visdrone.names"
...
__C.TRAIN.ANNOT_PATH            = "./VisDrone2018-tf-yolo/train.txt"
...
__C.TEST.ANNOT_PATH             = "./VisDrone2018-tf-yolo/test.txt"
